...
const staffMembers = [
    ...
    },
    {
        role: "チームアドバイザー",
        name: "難波 毅",
        description: "※JSPO公認スポーツ指導者\n現在も現役選手として活躍中 野球歴：30年以上。押しつけず選手に考えてもらう余白を残すコーチングを実演。主に高学年を中心とした練習では（通称：難波塾）一気に伸びる選手も珍しくありません。"
    },
    {
        role: "コーチ",
        name: "野田 尚幸",
        description: "※JSPO公認スポーツ指導者\n※JSBB公認学童コーチ\n城西大学出身 野球歴：25年以上。2022年にチームを立ち上げた発起人。「子ども達へ野球の楽しさを伝える！」その思いは設立後決してブレることなく、今日のチーム運営を根幹から支えています！"
    },
    {
        role: "コーチ",
        name: "小野寺 祥一",
        description: "※JSBB公認学童コーチ\n聖光学院出身 甲子園出場経験有。キャッチャーとして甲子園に出場しており、その経験から主にバッテリーコーチとしてコーチングしています。"
    },
    {
        role: "コーチ",
        name: "藤原 朋弘",
    ...
    },
    {
        role: "コーチ",
        name: "野地 忠行",
        description: "※JSPO公認スポーツ指導者\n野球未経験という異色！？のコーチ。ISIA取得の経験を活かし、主に低学年向のコーチングを担当します。"
    },
]
